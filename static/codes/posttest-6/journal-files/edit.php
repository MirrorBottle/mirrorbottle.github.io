...
if(isset($_POST['name'])) {
  ...
  if($_FILES['file']['name'] != '') {
    ...
    $data["file"] = $filename;
    $data["uploaded_at"] = $_POST['uploaded_at'];
  }
	
  update("journal_files", $data);
  ...
  <main id="home-page">
    ...
    <section id="static" class="container row pt-4 mt-4 pb-4 mb-4">
      <form action="" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="id" required value="<?= $file['id'] ?>">
        <div class="row w-100">
          <div class="col col-12">
            <h1 class="mb-0 font-light">Ubah File Jurnal - <?= $journal['title'] ?></h1>
            <p>*File tidak perlu diupload apabila tidak ada perubahan</p>
          </div>
          <div class="col col-12">
