...
if(isset($_POST['keyword'])) {
  $journals = query("SELECT * FROM journals WHERE title LIKE '%{$_POST['keyword']}%'");
}
?>
            ...
            <div class="row w-100">
              <div class="col col-11">
                <div class="form-control row">
                  <div class="col col-3">
                    <label for="title">Pencarian</label>
                  </div>
                  <div class="col col-9">
                    <input type="text" name="keyword" placeholder="Cari berdasarkan judul...">
                  </div>
                </div>
              </div>
              <div class="col col-1 flex align-items-center">
